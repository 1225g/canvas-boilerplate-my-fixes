...
/* harmony import */ var _chriscourses_perlin_noise__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @chriscourses/perlin-noise */ "./node_modules/@chriscourses/perlin-noise/index.js");
...
var circles = [];
for (var i = 0; i < 100; i++) {
  circles.push(new Circle(-30, -30, 100 * Math.random(), "hsl(".concat(Math.random() * 255, ", 100%, 50%)"), i * 0.01));
}
var time = 0;
// Animation Loop
function animate() {
  ...
  circles.forEach(function (circle) {
    circle.x = (0,_chriscourses_perlin_noise__WEBPACK_IMPORTED_MODULE_1__.noise)(time + circle.offset + 20) * canvas.width;
    circle.y = (0,_chriscourses_perlin_noise__WEBPACK_IMPORTED_MODULE_1__.noise)(time + circle.offset) * canvas.height;
    circle.draw();
  });
  // circle.update()
